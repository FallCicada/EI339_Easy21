...
class MCMC:
    ...
    def save_fig(self, fig_path):
        plot_Q(self.q_table, save_path=(fig_path + "MCMC.png"))

    def save_result(self, log_path):
        with open(log_path + "MCMC.txt", "w") as f:
...
if __name__ == "__main__":
    ...
    plot_learning_curve(ave_rewards, rmses, names)
