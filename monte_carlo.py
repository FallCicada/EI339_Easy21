...
class MCMC:
    def __init__(self, env: Easy21, learning_rate=0.05, reward_decay=1.):
        ...
        self.q_table = {state: [0, 0] for state in self.non_terminal_state_space}
        self.count = {state: [0, 0] for state in self.non_terminal_state_space}
...
def main():
    ...
    plot_learning_curve(ave_rewards, rmses, names, save_path=fig_path + "MCMC_reward.png", show=True)
